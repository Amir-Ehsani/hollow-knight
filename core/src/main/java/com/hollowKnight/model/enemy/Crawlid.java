...
public class Crawlid implements Damageable {

    public enum State {
        WALKING, TURNING, DYING, DEAD
    }

    public static final float DEFAULT_HITBOX_WIDTH = 52f;
    public static final float DEFAULT_HITBOX_HEIGHT = 28f;
    public static final int DEFAULT_HEALTH = 2;
    public static final float DEFAULT_SPEED = 58f;
    public static final float DEFAULT_DRAW_SCALE = 1.00f;
    ...
    private static final float CLIFF_CHECK_DISTANCE_X = 9f;
    private static final float CLIFF_CHECK_DISTANCE_Y = 9f;
    private static final float TURN_DURATION = 0.24f;
    private static final float DEATH_DURATION = 0.50f;
    private static final float HURT_KNOCKBACK_DURATION = 0.14f;
    ...
    public void takeDamage(int damage, float knockbackX, float knockbackY) {
        ...
        if (currentHealth <= 0) {
            ...
            velocity.x = knockbackX * 0.85f;
            velocity.y = Math.max(velocity.y, knockbackY * 0.65f);
            grounded = false;
        }
    }
